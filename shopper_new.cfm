        ...
        <form class="shippingForm">
            <div class="shippingParent">
                ...
                <div class="shippingLabel">
                    <span>Store Pickup</span><a href="##">Change Store</a><span>free</span>
                </div>
                <p>Ship everything for free to my local store
in Overland Park, KS</p>
            </div>
            <div class="shippingParent">
                <input type="radio" name="shipping" value="Shipping" class="shippingRadio" >
                <div class="shippingLabel">
                    <span>Shipping</span><span>$3.99 Flat Rate Shipping</span>
                </div>
